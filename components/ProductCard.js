    ...
    <div className="relative rounded-md">
      <Link href={`/product/${slug}`}>
        <div className="relative ">
          ...
          <div className="flex group relative  md:w-full bg-[#e8e8e8] h-[161.66px] md:h-[287.425px] justify-end items-center flex-col min-w-[161.66px] md:min-w-[287.425px] lg:min-w-[387.425px] lg:min-h-[387.425px] xl:min-w-[387.425px] xl:min-h-[387.425px]">
