    ...
    <div className="flex justify-between md:justify-evenly items-center shadow-sm px-5 md:px-0 md:py-4 max-w-8xl m-auto">
      ...
      <div className="flex justify-center items-center md:space-x-10 space-x-6 mt-6">
        ...
        {session ? (
          ...
          <Link href="/login">
            <a className="relative rounded px-5 py-2.5 overflow-hidden group bg-primary-1 relative hover:bg-gradient-to-r hover:from-primary-1 hover:to-primary-1 text-white hover:ring-2 hover:ring-offset-2 hover:ring-primary-1 transition-all ease-out duration-300">
